        ...
        <div className="tool-bnits py-5">
            <Container className="themed-container" fluid={false}>
                <div className="text-center tool-head">
                    <h2>Tool & <span className="skycolor">Technology</span></h2>
                    <h4>We use to make your mobile app come to life</h4>
                    <p>A Developer of CBNITS will pick the perfect Technology stack suited for your mobile app to <br/> be robust and scalable</p>
                </div>
