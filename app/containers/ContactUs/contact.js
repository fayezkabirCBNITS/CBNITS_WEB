...
import { Nav, NavItem, Button, NavLink, Row, Col, Container, Form, FormGroup, Label, Input } from "reactstrap";
                ...
                <Container className="themed-container" fluid={false}>
                    <Row className="d-flex align-items-center">
                        <Col xl={4} lg={4} md={4} sm={12} xs={12}>
                            <div className="contact-head">
                                ...
                                <div>
                                    ...
                                    <Row>
                                        <Col xl={1} lg={1}>
                                            <FontAwesomeIcon icon={faMapMarkerAlt} className="fontIcon" />
                                        </Col>
                                        <Col xl={11} lg={11}>
                                ...
                                <div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11}>
                                            <p>Webel IT Park DH 6/6 Action Area 1, Rajarhat, New Town Kolkata-700156</p>
                                        </Col>
                                    </Row>
                                    <Row>
                                        <Col xl={1} lg={1}>
                        ...
                        <Col xl={8} lg={8} md={8} sm={12} xs={12}>
                            <div>
                                <div className="form-head text-center" style={{marginTop:'120px'}}>
                                    <h2>Leave us a <span className="skycolor">Message</span></h2>
                                </div>
