...
const paraFirst = "With CBNITS top of the line Golang development services,bring"
                        ...
                        <Row className="d-flex align-items-center ">
                            ...
                            <Col xl={6} lg={6} md={6} sm={12} xs={12}>
                                <div className="advantages">
                                    <h6>Advantages of hiring Golang dvelopers from <span className="skycolor">CBNITS</span></h6>
